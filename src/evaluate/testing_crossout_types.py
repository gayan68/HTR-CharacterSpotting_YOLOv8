...
parser.add_argument("dir_label_test")
...
df_menu = ["Architecture","Trained_on","Score","Model_ID","CLEAN","MIXED","MIXED_2","MIXED_3","SINGLE_LINE","DOUBLE_LINE","DIAGONAL","CROSS","WAVE","ZIG_ZAG","SCRATCH"]

df_data = [
        ["YOLO", args.trained_on, "CER", args.model_id, list_cer_best_c[0], list_cer_best_c[1], 0, 0, list_cer_best_c[2], list_cer_best_c[3], list_cer_best_c[4], list_cer_best_c[5], list_cer_best_c[6], list_cer_best_c[7], list_cer_best_c[8]],
        ["YOLO", args.trained_on, "WER", args.model_id, list_wer_best_c[0], list_wer_best_c[1], 0, 0, list_wer_best_c[2], list_wer_best_c[3], list_wer_best_c[4], list_wer_best_c[5], list_wer_best_c[6], list_wer_best_c[7], list_wer_best_c[8]]
    ]

df = pd.DataFrame(df_data, columns= df_menu)

df.to_csv(f"yolo_results_types_{args.model_id}.csv", index=False)