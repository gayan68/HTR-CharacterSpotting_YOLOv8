...
df_menu = ["Method","COR","Training_Data","CER_Clean","CER_Mix","WER_Clean","WER_Mix"]

df_data = [
        ["YOLO","No","NA", list_cer_best_c[0], list_cer_best_m[0], list_wer_best_c[0], list_wer_best_m[0]],
        ["YOLO","Yes","NA", list_cer_best_c[1], list_cer_best_m[1], list_wer_best_c[1], list_wer_best_m[1]],
    ]
